...
namespace LambdaExpressionAssignment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Number of employees with the first name \"Joe\" using lambda expression: " + joes2.Count);
            Console.WriteLine("Number of employees with Id number greater than 5 using lambda expression: " + bigId.Count);
            Console.ReadLine();
        }
    }
}
